...
- **@typescript-eslint/eslint-plugin** (8.52.0): TypeScript-specific ESLint rules
- **@typescript-eslint/parser** (8.52.0): TypeScript parser for ESLint
- **eslint** (9.39.2): JavaScript/TypeScript linter
- **prettier** (3.7.4): Code formatter
- **vitest** (4.0.16): Testing framework for TypeScript
- **@vitest/coverage-v8** (4.0.16): Code coverage tool
