...
- **Name:** "Toomas633's Dungeon" Backend (v2.1.1)
- **Stack:** Node.js 18+ (24+ recommended) with Express.js 5.2.1 and TypeScript using ESM modules
- **Purpose:** Backend API server providing email functionality and GitHub integration for the frontend homepage
...
- **Framework:** Express.js 5.2.1 with TypeScript types and ESM modules
...
- **express** (5.2.1): Web framework with TypeScript type definitions
- **nodemailer** (8.0.9): SMTP email transport with types
- **axios** (1.16.1): HTTP client for external API requests (GitHub)
...
- **swagger-jsdoc** (6.3.0): OpenAPI specification generation
- **js-yaml** (4.1.1): YAML configuration file parsing
...
- **@types/body-parser** (1.19.6): TypeScript definitions for body-parser
- **@types/swagger-ui-express** (4.1.8): TypeScript definitions for Swagger UI
...
- **tsx** (4.22.3): Fast TypeScript execution for development
- **esbuild** (0.28.0): Fast JavaScript bundler for production builds
- **@types/\*** TypeScript type definitions for all dependencies
- **@typescript-eslint/eslint-plugin** (8.60.0): TypeScript-specific ESLint rules
- **@typescript-eslint/parser** (8.60.0): TypeScript parser for ESLint
- **eslint** (10.4.0): JavaScript/TypeScript linter
- **prettier** (3.8.3): Code formatter
- **vitest** (4.1.7): Testing framework for TypeScript
- **@vitest/coverage-v8** (4.1.7): Code coverage tool
- **supertest** (7.2.2): HTTP assertion library for API testing
- **@types/supertest** (7.2.0): TypeScript definitions for supertest
...
│   │   ├── swagger.ts        # Swagger loader (loads YAML configs)
│   │   ├── swagger.yaml      # OpenAPI base configuration (info, servers, schemas)
│   │   └── swagger-paths.yaml # OpenAPI paths/endpoints specification
│   ├── middleware/
...
│   │   └── github.ts         # GitHub API proxy endpoint
│   ├── services/
│   │   ├── emailService.ts   # Nodemailer transport and email operations
│   │   └── githubService.ts  # GitHub API client for repository data
│   ├── types/
...
│   ├── routes/               # Route handler tests (including swagger.spec.ts)
│   ├── services/             # Service layer tests
│   └── utils/                # Utility function tests
├── dist/                      # Compiled JavaScript output (gitignored)
│   └── config/               # YAML files copied during build
│       ├── swagger.yaml
│       └── swagger-paths.yaml
...
├── esbuild.config.js         # esbuild bundler with YAML file copying
...
- **Health Checks:** `/api/health` endpoint with email service verification
...
```bash
# Development
npm run dev          # Fast development with tsx watch mode (no build step)
...
# Docker
docker build -t backend .      # Build container image
docker-compose up -d           # Start development compose
...
- **Vitest (4.1.7):** Modern testing framework with TypeScript support
...
- **Health Check:** Automatic `/api/health` endpoint monitoring
...
- **[Main README](../README.md)** - Project overview and full-stack architecture
- **[Backend README](README.md)** - Backend-specific setup and documentation
- **[Frontend README](../frontend/README.md)** - Frontend application documentation
- **[Frontend Copilot Instructions](../frontend/.github-copilot-instructions.md)** - Frontend development patterns
- **[Root Copilot Instructions](../.github/copilot-instructions.md)** - Overall project guidelines

### Technical Documentation

- **[API Documentation](../docs/API.md)** - Complete API reference with request/response examples
	- `GET /api/health` - Health check endpoint with email verification
...
- **[Troubleshooting](../docs/TROUBLESHOOTING.md)** - Common backend issues and solutions
- **[Contributing Guide](../CONTRIBUTING.md)** - Contribution guidelines and workflow
- **[Changelog](../CHANGELOG.md)** - Version history and release notes

### Configuration Files

- **[TypeScript Config](tsconfig.json)** - Compiler options and module resolution
- **[Vitest Config](vitest.config.ts)** - Testing framework configuration
- **[ESLint Config](eslint.config.js)** - Code linting rules
- **[Docker Compose](../docker-compose.yml)** - Development container setup
