...
- **nodemailer** (7.0.11): SMTP email transport with types
...
- **body-parser** (2.2.1): JSON request parsing
...
- **@types/nodemailer** (7.0.4): TypeScript definitions for Nodemailer
...
- **esbuild** (0.27.1): Fast JavaScript bundler for production builds
- **@types/\*** TypeScript type definitions for all dependencies
- **@typescript-eslint/eslint-plugin** (8.48.1): TypeScript-specific ESLint rules
- **@typescript-eslint/parser** (8.48.1): TypeScript parser for ESLint
- **eslint** (9.39.1): JavaScript/TypeScript linter
- **prettier** (3.7.4): Code formatter
- **vitest** (4.0.15): Testing framework for TypeScript
- **@vitest/coverage-v8** (4.0.15): Code coverage tool
...
- **Vitest (4.0.15):** Modern testing framework with TypeScript support
...
- **[API Documentation](../docs/API.md)** - Complete API reference with request/response examples
  - `GET /health` - Health check endpoint with email verification
