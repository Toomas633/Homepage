...
- **Name:** "Toomas633's Dungeon" Backend (v2.1.0)
...
- **nodemailer** (7.0.12): SMTP email transport with types
- **axios** (1.13.2): HTTP client for external API requests (GitHub)
...
- **@types/nodemailer** (7.0.5): TypeScript definitions for Nodemailer
...
- **tsx** (4.21.0): Fast TypeScript execution for development
- **esbuild** (0.27.2): Fast JavaScript bundler for production builds
- **@types/\*** TypeScript type definitions for all dependencies
- **@typescript-eslint/eslint-plugin** (8.53.0): TypeScript-specific ESLint rules
...
- **vitest** (4.0.17): Testing framework for TypeScript
- **@vitest/coverage-v8** (4.0.17): Code coverage tool
...
- **globals** (17.0.0): Global identifiers for ESLint
...
- **Vitest (4.0.17):** Modern testing framework with TypeScript support
